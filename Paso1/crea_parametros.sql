...
INSERT INTO params_des(ENTIDAD,PARAMETRO,VALOR,ORDEN,AMBIENTE) VALUES('D_SHTRMNLSMCRDS0010','VAL_SFTP_RUTA_1','''"/Inteligencia~}<de~}<Mercado/07_Analisis_epc-rlf/02_Análisis/Terminales/Catalogos"''','0','1');
INSERT INTO params_des(ENTIDAD,PARAMETRO,VALOR,ORDEN,AMBIENTE) VALUES('D_SHTRMNLSMCRDS0010','VAL_SFTP_RUTA_2','''"/Business~}<Intelligence/3_Operaciones/Procesos/EMERGENTE/NC/PARQUE/CATALOGO"''','0','1');
