...
INSERT INTO params_des(ENTIDAD,PARAMETRO,VALOR,ORDEN,AMBIENTE) VALUES('D_SHTRMNLSMCRDS0010','VTABLADESTINO','otc_t_terminales_simcards','0','0');
...
INSERT INTO params_des(ENTIDAD,PARAMETRO,VALOR,ORDEN,AMBIENTE) VALUES('D_URMCBMBILL4060','VAL_NUM_EXECUTORS_CORES','6','0','0');
...
INSERT INTO params_des(ENTIDAD,PARAMETRO,VALOR,ORDEN,AMBIENTE) VALUES('D_URMTRMNLSVUSR4050','HIVETABLE','otc_t_v_usuarios',0,0);
...
INSERT INTO params_des(ENTIDAD,PARAMETRO,VALOR,ORDEN,AMBIENTE) VALUES('D_TRMNLSFCT0040','HIVETABLE','otc_t_terminales_fact',0,0);
INSERT INTO params_des(ENTIDAD,PARAMETRO,VALOR,ORDEN,AMBIENTE) VALUES('D_TRMNLSFCT0040','HIVEDB','db_desarrollo2021',0,0);
INSERT INTO params_des(ENTIDAD,PARAMETRO,VALOR,ORDEN,AMBIENTE) VALUES('D_TRMNLSFCT0040','VAL_TIPO_CARGA','append',0,0);
INSERT INTO params_des(ENTIDAD,PARAMETRO,VALOR,ORDEN,AMBIENTE) VALUES('D_TRMNLSFCT0040','VAL_MASTER','local','0','0');
INSERT INTO params_des(ENTIDAD,PARAMETRO,VALOR,ORDEN,AMBIENTE) VALUES('D_TRMNLSFCT0040','VAL_DRIVER_MEMORY','16G','0','0');
INSERT INTO params_des(ENTIDAD,PARAMETRO,VALOR,ORDEN,AMBIENTE) VALUES('D_TRMNLSFCT0040','VAL_EXECUTOR_MEMORY','16G','0','0');
...
INSERT INTO params_des(ENTIDAD,PARAMETRO,VALOR,ORDEN,AMBIENTE) VALUES('D_TRMNLSNC0030','HIVETABLE','otc_t_terminales_nc',0,0);
INSERT INTO params_des(ENTIDAD,PARAMETRO,VALOR,ORDEN,AMBIENTE) VALUES('D_TRMNLSNC0030','HIVEDB','db_desarrollo2021',0,0);
INSERT INTO params_des(ENTIDAD,PARAMETRO,VALOR,ORDEN,AMBIENTE) VALUES('D_TRMNLSNC0030','VAL_TIPO_CARGA','append',0,0);
...
INSERT INTO params_des(ENTIDAD,PARAMETRO,VALOR,ORDEN,AMBIENTE) VALUES('D_TRMNLSNC0030','VAL_NUM_EXECUTORS','8','0','0');
...
INSERT INTO params_des(ENTIDAD,PARAMETRO,VALOR,ORDEN,AMBIENTE) VALUES('D_EXTRCTRTRMNLS0070','VAL_RUTA','/home/nae108834/cp_terminales_simcards','0','0');
INSERT INTO params_des(ENTIDAD,PARAMETRO,VALOR,ORDEN,AMBIENTE) VALUES('D_EXTRCTRTRMNLS0070','ETAPA','1','0','0');
INSERT INTO params_des(ENTIDAD,PARAMETRO,VALOR,ORDEN,AMBIENTE) VALUES('D_EXTRCTRTRMNLS0070','SHELL','/home/nae108834/cp_terminales_simcards/bin/OTC_T_EXT_TERMINALES.sh','0','0');
INSERT INTO params_des(ENTIDAD,PARAMETRO,VALOR,ORDEN,AMBIENTE) VALUES('D_EXTRCTRTRMNLS0070','VAL_SFTP_PUERTO_OUT','22','0','1');
INSERT INTO params_des(ENTIDAD,PARAMETRO,VALOR,ORDEN,AMBIENTE) VALUES('D_EXTRCTRTRMNLS0070','VAL_SFTP_USER_OUT','telefonicaecuadorprod','0','1');
INSERT INTO params_des(ENTIDAD,PARAMETRO,VALOR,ORDEN,AMBIENTE) VALUES('D_EXTRCTRTRMNLS0070','VAL_SFTP_HOSTNAME_OUT','ftp.cloud.varicent.com','0','1');
INSERT INTO params_des(ENTIDAD,PARAMETRO,VALOR,ORDEN,AMBIENTE) VALUES('D_EXTRCTRTRMNLS0070','VAL_SFTP_PASS_OUT','RqiZ2lkJmeiQTi2hvRwd','0','1');
INSERT INTO params_des(ENTIDAD,PARAMETRO,VALOR,ORDEN,AMBIENTE) VALUES('D_EXTRCTRTRMNLS0070','VAL_SFTP_RUTA_OUT','/Data','0','1');
INSERT INTO params_des(ENTIDAD,PARAMETRO,VALOR,ORDEN,AMBIENTE) VALUES('D_EXTRCTRTRMNLS0070','VAL_NOM_ARCHIVO','Extractor_Terminales.txt','0','1');
INSERT INTO params_des(ENTIDAD,PARAMETRO,VALOR,ORDEN,AMBIENTE) VALUES('D_EXTRCTRTRMNLS0070','VAL_DIR_HDFS_CAT','db_desarrollo2021.otc_t_ajsts_terminales',1,1);  --- reportes
INSERT INTO params_des(ENTIDAD,PARAMETRO,VALOR,ORDEN,AMBIENTE) VALUES('D_EXTRCTRTRMNLS0070','VTFINAL','db_desarrollo2021.otc_t_ext_terminales_ajst',1,1);  --- reportes
INSERT INTO params_des(ENTIDAD,PARAMETRO,VALOR,ORDEN,AMBIENTE) VALUES('D_EXTRCTRTRMNLS0070','VAL_SFTP_RUTA','"COMISIONES/Indirectos/Multipais/PROYECTO_COMISIONES/FACTURACION_TERMINALES"',0,1);
INSERT INTO params_des(ENTIDAD,PARAMETRO,VALOR,ORDEN,AMBIENTE) VALUES('D_EXTRCTRTRMNLS0070','VAL_SFTP_NOM_ARCHIVO','AJUSTES_TERMINALES.xlsx',0,1);
