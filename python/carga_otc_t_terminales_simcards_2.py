...
try:
    ...
    #df_tmp_catalogo_terminales_csts.write.format("parquet").mode("overwrite").saveAsTable("db_desarrollo2021.cs_termi_01")
    ...
    #df_tmp_facturas_csts.write.format("parquet").mode("overwrite").saveAsTable("db_desarrollo2021.cs_termi_02")
    ...
    #df_tmp_notas_credito_csts.write.format("parquet").mode("overwrite").saveAsTable("db_desarrollo2021.cs_termi_03")
    ...
    #df_tmp_orden_venta_csts.write.format("parquet").mode("overwrite").saveAsTable("db_desarrollo2021.cs_termi_04")
    ...
    #df_tmp_imei_articulo_csts.write.format("parquet").mode("overwrite").saveAsTable("db_desarrollo2021.cs_termi_05")
    ...
    #df_tmp_facturacion_usuario_csts.write.format("parquet").mode("overwrite").saveAsTable("db_desarrollo2021.cs_termi_06")
    ...
    #df_tmp_nota_credito_usuario_csts.write.format("parquet").mode("overwrite").saveAsTable("db_desarrollo2021.cs_termi_07")
    ...
    #df_tmp_une_fact_notascred_csts.write.format("parquet").mode("overwrite").saveAsTable("db_desarrollo2021.cs_termi_08")
    ...
    #df_tmp_clientes_csts.write.format("parquet").mode("overwrite").saveAsTable("db_desarrollo2021.cs_termi_09")
    ...
    #df_tmp_clientes_categoria_csts.write.format("parquet").mode("overwrite").saveAsTable("db_desarrollo2021.cs_termi_10")
    ...
    #df_tmp_imei_cod_articulo_csts.write.format("parquet").mode("overwrite").saveAsTable("db_desarrollo2021.cs_termi_11")
    ...
    #df_tmp_agrupa_imei_codart_csts.write.format("parquet").mode("overwrite").saveAsTable("db_desarrollo2021.cs_termi_12")
    ...
    #df_tmp_resto_segmento_csts.write.format("parquet").mode("overwrite").saveAsTable("db_desarrollo2021.cs_termi_13")
    ...
    #df_tmp_terminal_equipo_csts.write.format("parquet").mode("overwrite").saveAsTable("db_desarrollo2021.cs_termi_14")
    ...
    #df_tmp_usuario_cm_csts.write.format("parquet").mode("overwrite").saveAsTable("db_desarrollo2021.cs_termi_15")
    ...
    #df_tmp_trmnl_eqp_canal_usu_csts.write.format("parquet").mode("overwrite").saveAsTable("db_desarrollo2021.cs_termi_16")
    ...
    #df_tmp_trmneqp_fuente_canal_csts.write.format("parquet").mode("overwrite").saveAsTable("db_desarrollo2021.cs_termi_17")
    ...
    #df_tmp_trmneqp_cruza_ruc_csts.write.format("parquet").mode("overwrite").saveAsTable("db_desarrollo2021.cs_termi_18")
    ...
    #df_tmp_trmneqp_update_canal_csts.write.format("parquet").mode("overwrite").saveAsTable("db_desarrollo2021.cs_termi_19")
    ...
    #df_tmp_trmneqp_full_name_csts.write.format("parquet").mode("overwrite").saveAsTable("db_desarrollo2021.cs_termi_20")
    ...
    #df_tmp_mov_parque_completa_csts.write.format("parquet").mode("overwrite").saveAsTable("db_desarrollo2021.cs_termi_21")
    ...
    #df_tmp_mov_parque_completa_ant_csts.write.format("parquet").mode("overwrite").saveAsTable("db_desarrollo2021.cs_termi_22")
    ...
    #df_tmp_mov_parque_sin_dup_csts.write.format("parquet").mode("overwrite").saveAsTable("db_desarrollo2021.cs_termi_23")
    ...
    #df_tmp_mov_parque_ant_sin_dup_csts.write.format("parquet").mode("overwrite").saveAsTable("db_desarrollo2021.cs_termi_24")
    ...
    #df_tmp_movparque_sin_dup_csts.write.format("parquet").mode("overwrite").saveAsTable("db_desarrollo2021.cs_termi_25")
    ...
    #df_tmp_movparque_seg_csts.write.format("parquet").mode("overwrite").saveAsTable("db_desarrollo2021.cs_termi_26")
    ...
    #df_tmp_universo_ppal_mov_csts.write.format("parquet").mode("overwrite").saveAsTable("db_desarrollo2021.cs_termi_27")
    ...
    #df_tmp_mov_parque_antiguo_csts.write.format("parquet").mode("overwrite").saveAsTable("db_desarrollo2021.cs_termi_28")
    ...
    #df_tmp_mov_parque_nuevo_csts.write.format("parquet").mode("overwrite").saveAsTable("db_desarrollo2021.cs_termi_29")
    ...
    #df_tmp_movimientos_bi_csts.write.format("parquet").mode("overwrite").saveAsTable("db_desarrollo2021.cs_termi_30")
    ...
    #df_tmp_trmneqp_movimiento_csts.write.format("parquet").mode("overwrite").saveAsTable("db_desarrollo2021.cs_termi_31")
    ...
    #df_tmp_cuentas_un_min_csts.write.format("parquet").mode("overwrite").saveAsTable("db_desarrollo2021.cs_termi_32")
    ...
    #df_tmp_mines1_cuenta_un_min_csts.write.format("parquet").mode("overwrite").saveAsTable("db_desarrollo2021.cs_termi_33")
    ...
    #df_tmp_mov_mines_bi_csts.write.format("parquet").mode("overwrite").saveAsTable("db_desarrollo2021.cs_termi_34")
    ...
    #df_tmp_fact_mov_pre_csts.write.format("parquet").mode("overwrite").saveAsTable("db_desarrollo2021.cs_termi_35")
    ...
    #df_tmp_cuentas_sin_min_csts.write.format("parquet").mode("overwrite").saveAsTable("db_desarrollo2021.cs_termi_36")
    ...
    #df_tmp_cuentas_completa_csts.write.format("parquet").mode("overwrite").saveAsTable("db_desarrollo2021.cs_termi_37")
    ...
    #df_tmp_fact_ppal_completa_csts.write.format("parquet").mode("overwrite").saveAsTable("db_desarrollo2021.cs_termi_38")
    ...
    #df_tmp_cuenta_segmento_csts.write.format("parquet").mode("overwrite").saveAsTable("db_desarrollo2021.cs_termi_39")
    ...
    #df_tmp_cuenta_seg_masivo_csts.write.format("parquet").mode("overwrite").saveAsTable("db_desarrollo2021.cs_termi_40")
    ...
    #df_tmp_universo_fact_mov_csts.write.format("parquet").mode("overwrite").saveAsTable("db_desarrollo2021.cs_termi_41")
    ...
    #df_tmp_universo_fact_mov2_csts.write.format("parquet").mode("overwrite").saveAsTable("db_desarrollo2021.cs_termi_42")
    ...
    #df_tmp_perimetros_unicos_csts.write.format("parquet").mode("overwrite").saveAsTable("db_desarrollo2021.cs_termi_43")
    ...
    #df_tmp_fact_mov_perimetro_csts.write.format("parquet").mode("overwrite").saveAsTable("db_desarrollo2021.cs_termi_44")
    ...
    #df_tmp_fact_mov_update_csts.write.format("parquet").mode("overwrite").saveAsTable("db_desarrollo2021.cs_termi_45")
    ...
    #df_tmp_mines_planes_csts.write.format("parquet").mode("overwrite").saveAsTable("db_desarrollo2021.cs_termi_46")
    ...
    #df_tmp_fact_mov_final_csts.write.format("parquet").mode("overwrite").saveAsTable("db_desarrollo2021.cs_termi_47")
    ...
    #df_tmp_fact_mov_final_upd_csts.write.format("parquet").mode("overwrite").saveAsTable("db_desarrollo2021.cs_termi_48")
    ...
    #df_tmp_fact_mov_final_upd1_csts.write.format("parquet").mode("overwrite").saveAsTable("db_desarrollo2021.cs_termi_49")
    ...
    #df_tmp_fact_mov_final_costo_csts.write.format("parquet").mode("overwrite").saveAsTable("db_desarrollo2021.cs_termi_50")
    ...
    #df_tmp_costo_x_modelo_csts.write.format("parquet").mode("overwrite").saveAsTable("db_desarrollo2021.cs_termi_51")
    ...
    #df_tmp_costo_sin_imei_csts.write.format("parquet").mode("overwrite").saveAsTable("db_desarrollo2021.cs_termi_52")
    ...
    #df_tmp_costo_rep_anterior_csts.write.format("parquet").mode("overwrite").saveAsTable("db_desarrollo2021.cs_termi_53")
    ...
    #df_tmp_costo_fac_final_csts.write.format("parquet").mode("overwrite").saveAsTable("db_desarrollo2021.cs_termi_54")
    ...
    #df_tmp_cuota_monto_csts.write.format("parquet").mode("overwrite").saveAsTable("db_desarrollo2021.cs_termi_55")
    ...
    #df_tmp_cuotas_financiadas_csts.write.format("parquet").mode("overwrite").saveAsTable("db_desarrollo2021.cs_termi_56")
    ...
    #df_tmp_concepto_articulo_csts.write.format("parquet").mode("overwrite").saveAsTable("db_desarrollo2021.cs_termi_57")
    ...
    #df_tmp_billsummary_billseq_csts.write.format("parquet").mode("overwrite").saveAsTable("db_desarrollo2021.cs_termi_58")
    ...
    #df_tmp_fact_final_csts.write.format("parquet").mode("overwrite").saveAsTable("db_desarrollo2021.cs_termi_59")
    ...
    #df_tmp_fact_final_tipcanal_csts.write.format("parquet").mode("overwrite").saveAsTable("db_desarrollo2021.cs_termi_60")
    ...
    #df_tmp_campos_para_nc_csts.write.format("parquet").mode("overwrite").saveAsTable("db_desarrollo2021.cs_termi_61")
    ...
    #df_tmp_costos_fact_final_v2_csts.write.format("parquet").mode("overwrite").saveAsTable("db_desarrollo2021.cs_termi_62")
    ...
    #df_tmp_fact_final_update1_csts.write.format("parquet").mode("overwrite").saveAsTable("db_desarrollo2021.cs_termi_63")
    ...
    #df_tmp_fact_final_update2_csts.write.format("parquet").mode("overwrite").saveAsTable("db_desarrollo2021.cs_termi_64")
    ...
    #df_tmp_fact_final_update3_csts.write.format("parquet").mode("overwrite").saveAsTable("db_desarrollo2021.cs_termi_65")
    ...
    #df_tmp_fact_final_update4_csts.write.format("parquet").mode("overwrite").saveAsTable("db_desarrollo2021.cs_termi_66")
    ...
    #df_tmp_fact_final_update5_csts.write.format("parquet").mode("overwrite").saveAsTable("db_desarrollo2021.cs_termi_67")
    ...
    #df_tmp_fact_final_update6_csts.write.format("parquet").mode("overwrite").saveAsTable("db_desarrollo2021.cs_termi_68")
    ...
    #df_tmp_costo_fact_final_v2_1_csts.write.format("parquet").mode("overwrite").saveAsTable("db_desarrollo2021.cs_termi_69")
    ...
    #df_tmp_costo_fact_final_v3_csts.write.format("parquet").mode("overwrite").saveAsTable("db_desarrollo2021.cs_termi_70")
    ...
    #df_tmp_costo_fact_final_v4_csts.write.format("parquet").mode("overwrite").saveAsTable("db_desarrollo2021.cs_termi_71")
    ...
    #df_tmp_costo_fact_final_v4up_csts.write.format("parquet").mode("overwrite").saveAsTable("db_desarrollo2021.cs_termi_72")
    ...
    #df_tmp_costo_fact_final_v5up_csts.write.format("parquet").mode("overwrite").saveAsTable("db_desarrollo2021.cs_termi_73")
    ...
    #df_tmp_costo_fact_final_v5_csts.write.format("parquet").mode("overwrite").saveAsTable("db_desarrollo2021.cs_termi_74")
    ...
    #df_tmp_tarjeta_banco_csts.write.format("parquet").mode("overwrite").saveAsTable("db_desarrollo2021.cs_termi_75")
    ...
    #df_tmp_tarjeta_banco1_csts.write.format("parquet").mode("overwrite").saveAsTable("db_desarrollo2021.cs_termi_76")
    ...
    #df_tmp_pivot_tarjeta_banco_csts.write.format("parquet").mode("overwrite").saveAsTable("db_desarrollo2021.cs_termi_77")
    ...
    #df_tmp_costo_fact_final_v6_csts.write.format("parquet").mode("overwrite").saveAsTable("db_desarrollo2021.cs_termi_78")
    ...
    #df_tmp_costo_fact_final_v4_1_csts.write.format("parquet").mode("overwrite").saveAsTable("db_desarrollo2021.cs_termi_79")
    ...
    #df_tmp_costo_fact_exporta_csts.write.format("parquet").mode("overwrite").saveAsTable("db_desarrollo2021.cs_termi_80")
    ...
    #df_tmp_costo_fact_exporta_otra_csts.write.format("parquet").mode("overwrite").saveAsTable("db_desarrollo2021.cs_termi_81")
    ...
    #df_tmp_costo_fact_exporta_otra1_csts.write.format("parquet").mode("overwrite").saveAsTable("db_desarrollo2021.cs_termi_82")
