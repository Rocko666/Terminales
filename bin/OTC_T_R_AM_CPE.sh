...
TDHOST_RDB=`mysql -N  <<<"select valor from params_des where ENTIDAD = 'D_SPARK_GENERICO' AND parametro = 'TDHOST_RDB';"`
...
## HIVETABLE="otc_t_r_am_cpe_prycldr"
